...
Begin VB.Form blnkbill 
   ...
   Begin VB.Menu edmenu 
      ...
      End
      Begin VB.Menu chgcell 
         Caption         =   "Change Cell"
      End
   End
End
Attribute VB_Name = "blnkbill"
...
Private Sub chgcell_Click()
    Dim s As String, t As String
    s = Grid1.TextMatrix(0, Grid1.Col)
    t = InputBox(s & ":", s & "....", Grid1.Text)
...
Private Sub delrec_Click()
    ...
    s = "Ok to remove " & Grid1.TextMatrix(Grid1.Row, 0) & "?"
...
Private Sub insrec_Click()
    ...
    Dim s As String
    f0 = InputBox("Ship To Location:", "New Location...", "")
    If Len(f0) = 0 Then Exit Sub
    f1 = InputBox("Address:", "Address...", "")
    If Len(f1) = 0 Then Exit Sub
    f2 = InputBox("City:", "City...", "")
    If Len(f2) = 0 Then Exit Sub
    f3 = InputBox("State:", "State...", "")
    If Len(f3) = 0 Then Exit Sub
    f4 = InputBox("Zip Code:", "Zip Code...", "")
    If Len(f4) = 0 Then Exit Sub
...
Private Sub prtaddr_Click()
    Dim rt As String, rf As String, rh As String
    rt = "Ship To Address Listing"
    rh = " "
...
Private Sub prtbill_Click()
    Dim db As ADODB.Connection, ds As ADODB.Recordset, tc As String
