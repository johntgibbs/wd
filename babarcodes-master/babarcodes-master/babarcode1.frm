...
Private Sub Form_Load()
    ...
    vberror_log = "\\bbb3-02-dc\f\user\waredist\temp\sqlerrors.txt"
    
    'Me.bbsr = "ODBC;DATABASE=WDRacks;DSN=wdracks"
    'Me.bbsr = "ODBC;DATABASE=WDRacks;UID=bbcwd500;PWD=brenham500;DSN=wdsql500"
    'Me.bbsr = "ODBC;DATABASE=BARacks;UID=bbcwd501;PWD=barrow501;DSN=wdsql501"
    Me.bbsr = "Driver={SQL Server};Server=bbba-01-wdsql;DATABASE=BARacks;UID=bbcwd501;PWD=barrow501"
    WDbbsr = Me.bbsr
    'logdir = "v:\testlogs\"
    'logdir = "\\bbc-01-prodtrk\wd\pallogs\"
    logdir = "\\bbba-03-dc\f\user\waredist\data\pallogs\"
    
    Set Wdb = CreateObject("ADODB.Connection")
    Wdb.Open WDbbsr
    
    'labfmtfile = "S:\wd\bin\labfmt.txt"
    labfmtfile = "\\bbba-03-dc\f\user\waredist\bin\labfmt.txt"
    load_labpics
    'labpics.Show
    Exit Sub
vberror:
