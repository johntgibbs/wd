...
'vberror:
    ...
    'Call vb_elog(eno, edesc, Me.Name, "refresh_grid", Form1.crt)
...
'vberror:
    'eno = Err.Number: edesc = Err.Description
    'Call vb_elog(eno, edesc, Me.Name, "refresh_list", Form1.crt)
    'If eno = -2147467259 Then
    '    Resume
    'Else
...
'vberror:
    'eno = Err.Number: edesc = Err.Description
    'Call vb_elog(eno, edesc, Me.Name, "refresh_wos_ado", Form1.crt)
    'If eno = -2147467259 Then
    '    Resume
    'Else
...
Private Sub Command2_Click()
    Dim db As dao.Database, ds As dao.Recordset, s As String, nc As String, i As Integer, zid As Long
    Dim eno As Long, edesc As String
    'On Error GoTo vberror
    ...
    sqlx = "select sequence_id from sequences where seq = 'Valuelists'"
    ...
    sqlx = "Update sequences set sequence_id = " & zid & " where seq = 'Valuelists'"
    db.Execute sqlx
