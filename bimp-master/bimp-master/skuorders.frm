...
Private Sub refresh_grid()
    ...
    End If
    ds.Close
    'oqty = groupitems_qty(msku, mplant, "ALL") * skurec(Val(msku)).pallet                   'jv081516
    'If oqty > 0 Then                                                        'jv081516
    '    s = "Groups-Not Posted" & Chr(9) & oqty & Chr(9) & Chr(9) & Chr(9) & oqty    'jv081516
    '    Grid1.AddItem s                                                     'jv081516
    'End If                                                                  'jv081516
...
Private Sub Form_Load()
    Me.Height = plantorders.Height
    Me.Top = plantorders.Top
...
Private Sub Grid1_DblClick()
    Dim i As Integer
    i = Val(Left(Grid1.TextMatrix(Grid1.Row, 0), 3))
    If Val(i) > 0 Then
