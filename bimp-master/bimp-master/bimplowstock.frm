...
Begin VB.Form bimplowstock 
   ...
   End
End
Attribute VB_Name = "bimplowstock"
...
Private Sub build_grid2()
    ...
    If Grid1.Rows > 1 Then
        For i = 1 To Grid1.Rows - 1
            If Val(Grid1.TextMatrix(i, 7)) >= Val(Grid1.TextMatrix(i, 6)) Then
    ...
    If ds.BOF = False Then                                                      'jv091616
        ...
        Do Until ds.EOF
            ...
            End If
            s = s & Chr(9) & "_"
            daze = DateDiff("d", ds!listdisplay, Now) '+ 1
            Grid2.AddItem s
            ds.MoveNext
        Loop
    End If
    ...
    Next i
    Grid2.Row = 1
    'Grid2.FormatString = "^Plant|^SKU|<Product|^Schedule Date|^Net|^LowQty"
    Grid2.FormatString = "^Plant|^SKU|<Product|^Next Available Date|^Net|^LowQty"    'jv083117
...
Private Sub Command2_Click()
    ...
    If Len(Dir("c:\program files\internet explorer\iexplore.exe")) <> 0 Then
        ...
        'Call htmlcolorgrid(Me, "s:\wd\html\stock.htm", Grid2, rt, rh, rf, "linen", "khaki", "white")
        Grid2.ColWidth(4) = 1000
        Grid2.ColWidth(5) = 1000
        Grid2.Redraw = True
        i = Shell("C:\program files\internet explorer\iexplore.exe c:\htmlgrid.htm", vbNormalFocus)
        'i = Shell("C:\program files\internet explorer\iexplore.exe s:\wd\html\stock.htm", vbNormalFocus)
        Exit Sub
    End If
    If Len(Dir("c:\program files\plus!\microsoft internet\iexplore.exe")) <> 0 Then
        ...
        'i = Shell("C:\program files\plus!\microsoft internet\iexplore.exe s:\wd\html\stock.htm", vbNormalFocus)
        Exit Sub
    End If
End Sub
...
Private Sub Form_Resize()
    ...
    If Me.Height > 2000 Then
        Grid2.Height = Me.Height - (Command1.Height * 3)
    End If
End Sub
