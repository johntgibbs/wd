...
Private Sub refresh_grid()
    ...
    Grid1.FontBold = True
    Grid1.FontSize = 8
    Grid1.Clear: Grid1.Rows = 1: Grid1.Cols = 15: Grid1.FixedCols = 3
        ...
        Do Until ds.EOF
            ...
            If List1 = "All" Then                                                   'jv031616
                If ds!plantwhs = branchrec(Val(ds!branchwhs)).supplier Then         'jv031616
                    'Grid1.AddItem s                                                 'jv031616
                    If ds!onhand <> 0 Or ds!onorder <> 0 Or ds!sales <> 0 Then Grid1.AddItem s      'jv101416
                End If                                                              'jv031616
            Else
                If ds!onhand <> 0 Or ds!onorder <> 0 Or ds!sales <> 0 Then Grid1.AddItem s      'jv101416
                'Grid1.AddItem s
