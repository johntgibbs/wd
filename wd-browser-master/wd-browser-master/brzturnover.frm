...
Private Sub refresh_grid()
    ...
    If ds.BOF = False Then
        ...
        Do Until ds.EOF
            ...
            End If
            s = s & Chr(9)              'jv020118
            If rcnt <> 0 And pcnt <> 0 Then s = s & Format((pcnt / rcnt) * 30, "0") 'Days Suppl
            hgrid.AddItem s
            ds.MoveNext
        Loop
    End If
    ...
    If Val(regkey) > 0 Then
        Me.Caption = "Region " & regkey.Caption & " Branch Pallet Turnover"
        For i = hgrid.Rows - 1 To 1 Step -1
            w = Val(hgrid.TextMatrix(i, 0))
            If w > 0 Then
                s = "D" & regkey
                If branchrec(w).region <> s Then
                    If hgrid.Rows > 2 Then              'jv032416
                        hgrid.RemoveItem i
                    Else                                'jv032416
                        hgrid.Rows = 1                  'jv032416
                        hgrid.AddItem " "               'jv032416
                    End If                              'jv032416
                End If
            End If
        Next i
...
Private Sub Form_Load()
    ...
    Combo1.AddItem "K10"
    Combo1.AddItem "T10"
    'MsgBox Me.Caption & " " & Form1.wdbranch
...
Private Sub prtmenu_Click()
    ...
    If Len(Dir("c:\program files\internet explorer\iexplore.exe")) <> 0 Then
        Call htmlcolorgrid(Me, localAppDataPath & "\htmlgrid.htm", hgrid, rt, rh, rf, "linen", "lightyellow", "white")
