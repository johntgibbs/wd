...
Private Sub brcode_Change()
    ...
    'wdb is the WDShip Database on BBC-08-SQLSVR
...
Private Sub Form_Resize()
    ...
    Grid2.Width = Form7.Width - 80
    
    If Form7.Height > 2000 Then
        Grid1.Height = Form7.Height - (Combo1.Height + 950)
    End If
End Sub
...
Private Sub prtord_Click()
    ...
    Open Form1.webdir & "\dry\orders\dsord" & plantcode & "." & Form7.brcode For Output As #1
    For i = 0 To Grid1.Rows - 1
